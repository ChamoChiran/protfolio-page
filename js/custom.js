...
var loadPortfolioSinglePage = function(id, href) {
	$.ajax({
		...
		error: function(jqXHR, textStatus, errorThrown) {
			// If AJAX fails (file://, CORS or server error), fallback to full-page navigation
			console.error('Failed to load portfolio page via AJAX:', href, textStatus, errorThrown);
